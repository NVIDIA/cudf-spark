...
trait GpuBatchScanExecMetrics extends GpuExec {
  ...
  override lazy val additionalMetrics: Map[String, GpuMetric] = Map(
    ...
    DATA_SIZE_AFTER_FILTER ->
      createSizeMetric(MODERATE_LEVEL, DESCRIPTION_DATA_SIZE_AFTER_FILTER),
    IO_WAIT_TIME -> createNanoTimingMetric(MODERATE_LEVEL, DESCRIPTION_IO_WAIT_TIME),
    ...
    ICEBERG_ASYNC_FILE_READ_TIME ->
      createNanoTimingMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_FILE_READ_TIME),
    ICEBERG_ASYNC_REQUEST_COUNT ->
      createMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_REQUEST_COUNT),
    ICEBERG_ASYNC_REQUESTED_BYTES ->
      createSizeMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_REQUESTED_BYTES),
    ICEBERG_ASYNC_FOOTER_READ_TIME ->
      createNanoTimingMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_FOOTER_READ_TIME),
    ICEBERG_ASYNC_FOOTER_REQUEST_COUNT ->
      createMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_FOOTER_REQUEST_COUNT),
    ICEBERG_ASYNC_FOOTER_REQUESTED_BYTES ->
      createSizeMetric(MODERATE_LEVEL, DESCRIPTION_ICEBERG_ASYNC_FOOTER_REQUESTED_BYTES),
