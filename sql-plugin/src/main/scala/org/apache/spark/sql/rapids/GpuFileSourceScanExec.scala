...
case class GpuFileSourceScanExec(
  ...
  override lazy val allMetrics = Map(
    ...
    ORC_STRIPE_FOOTER_PERFIO_READ_CALLS ->
      createMetric(DEBUG_LEVEL, DESCRIPTION_ORC_STRIPE_FOOTER_PERFIO_READ_CALLS),
    ORC_STRIPE_FOOTER_FALLBACK_READ_CALLS ->
      createMetric(DEBUG_LEVEL, DESCRIPTION_ORC_STRIPE_FOOTER_FALLBACK_READ_CALLS),
    ...
    ORC_REMOTE_PERFIO_READ_CALLS ->
      createMetric(DEBUG_LEVEL, DESCRIPTION_ORC_REMOTE_PERFIO_READ_CALLS),
    ORC_REMOTE_FALLBACK_READ_CALLS ->
      createMetric(DEBUG_LEVEL, DESCRIPTION_ORC_REMOTE_FALLBACK_READ_CALLS),
