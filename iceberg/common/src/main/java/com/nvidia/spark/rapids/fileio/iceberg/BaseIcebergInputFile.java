...
/** Base class for {@link RapidsInputFile} implementations backed by an Iceberg input file. */
public abstract class BaseIcebergInputFile implements RapidsInputFile {
  private final InputFile delegate;

  protected BaseIcebergInputFile(InputFile delegate) {
